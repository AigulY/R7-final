...
ActiveRecord::Schema[7.1].define(version: 2024_02_26_222021) do
  ...
  create_table "safety_managers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_safety_managers_on_email", unique: true
    t.index ["reset_password_token"], name: "index_safety_managers_on_reset_password_token", unique: true
  end
